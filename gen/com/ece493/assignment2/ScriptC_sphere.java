 ...
 * The source Renderscript file: /Users/jason_reddekopp/Documents/ECE493Assignment2/src/sphere.rs
 */
 ...
 * @hide
 */
public class ScriptC_sphere extends ScriptC {
    private static final String __rs_resource_name = "sphere";
    // Constructor
    public  ScriptC_sphere(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_sphere(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportFuncIdx_sphere = 2;
    public void invoke_sphere(int x, int y) {
        FieldPacker sphere_fp = new FieldPacker(8);
        sphere_fp.addI32(x);
        sphere_fp.addI32(y);
        invoke(mExportFuncIdx_sphere, sphere_fp);
    }
