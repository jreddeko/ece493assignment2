 ...
 * The source Renderscript file: /Users/jason_reddekopp/Documents/ECE493Assignment2/src/ripple.rs
 */
 ...
 * @hide
 */
public class ScriptC_ripple extends ScriptC {
    private static final String __rs_resource_name = "ripple";
    // Constructor
    public  ScriptC_ripple(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_ripple(RenderScript rs, Resources resources, int id) {
    ...
    private final static int mExportFuncIdx_ripple = 2;
    public void invoke_ripple(int param) {
        FieldPacker ripple_fp = new FieldPacker(4);
        ripple_fp.addI32(param);
        invoke(mExportFuncIdx_ripple, ripple_fp);
    }
