 ...
 * The source Renderscript file: /Users/jason_reddekopp/Documents/ECE493Assignment2/src/transform.rs
 */
...
public class ScriptC_transform extends ScriptC {
    ...
    public void invoke_swirl() {
        invoke(mExportFuncIdx_swirl);
    }

    private final static int mExportFuncIdx_swirl2 = 3;
    public void invoke_swirl2() {
        invoke(mExportFuncIdx_swirl2);
    }

    private final static int mExportFuncIdx_ripple = 4;
    public void invoke_ripple() {
        invoke(mExportFuncIdx_ripple);
    }

    private final static int mExportFuncIdx_sphere = 5;
    public void invoke_sphere() {
        invoke(mExportFuncIdx_sphere);
    }

    private final static int mExportFuncIdx_bulge = 6;
